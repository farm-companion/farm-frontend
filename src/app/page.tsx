...
export default function Home() {
  return (
    <div className="min-h-screen bg-background-canvas">
      ...
      <main id="main" className="container mx-auto px-4 py-6 sm:py-8 lg:py-12">
        ...
        <section className="text-center py-8 sm:py-12 lg:py-16">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center">
            <Link href="/map" className="btn-primary touch-target w-full sm:w-auto px-6 py-3 text-base sm:text-lg">
              Explore Farm Shops
            </Link>
            <Link href="/seasonal" className="btn-secondary touch-target w-full sm:w-auto px-6 py-3 text-base sm:text-lg">
              What&apos;s in Season
            </Link>
          </div>
        </section>
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 py-12 sm:py-16">
          <div className="card text-center p-6 sm:p-8">
            <div className="mb-4 sm:mb-6">
              <svg className="w-10 h-10 sm:w-12 sm:h-12 mx-auto text-brand-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section className="text-center py-8 sm:py-12 lg:py-16 bg-background-surface rounded-lg px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center">
            ...
            <Link href="/counties" className="btn-secondary touch-target w-full sm:w-auto px-6 py-3 text-base sm:text-lg">
              Browse by County
            </Link>
          </div>
        </section>
        ...
        <section className="py-12 sm:py-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="order-2 lg:order-1">
              ...
              <Link href="/about" className="link text-sm sm:text-base inline-flex items-center gap-2 touch-target">
            ...
            <div className="order-1 lg:order-2 relative">
              <div className="aspect-video bg-background-surface rounded-lg flex items-center justify-center p-4">
                <span className="text-text-muted text-sm sm:text-base">Farm Shop Image</span>
              </div>
            </div>
          </div>
        </section>
